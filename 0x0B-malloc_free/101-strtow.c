 ...
 * @str: the string
 *
 * Return: returns a pointer to an array of string (words)
 */
...
/**
 * utill - a utill function for fetching words into an array
 * @words: the strings array
 * @str: the string
 */
void utill(char **words, char *str)
{
	int i, j, start, flag;
